...
import 'package:mau_masak/pages/admin/reportpostingan/detaillappostingan_controller.dart';
import 'package:mau_masak/theme/styles.dart';

class DetailLaporanPostinganView extends StatelessWidget {
  const DetailLaporanPostinganView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: GetBuilder<DetailLaporanPostinganController>(
            init: DetailLaporanPostinganController(),
            builder: (controller) {
              return Padding(

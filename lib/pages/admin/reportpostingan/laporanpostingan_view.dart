...
import 'package:mau_masak/pages/admin/reportpostingan/laporanpostingan_controller.dart';
import 'package:mau_masak/routes/page_names.dart';
import 'package:mau_masak/theme/styles.dart';

class LaporanPostinganView extends StatelessWidget {
  const LaporanPostinganView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<LaporanPostinganController>(
          init: LaporanPostinganController(),
          builder: (controller) {
            return Padding(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      MaterialButton(
                                        onPressed: () {
                                          Get.toNamed(
                                              PageName.detaillaporanpostingan,
                                              arguments: ({
